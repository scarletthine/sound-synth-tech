        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 196.0, 496.0, 42.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 504.0, 448.0, 59.0, 22.0 ],
                    "text": "mute 1, 0"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 823.0, 252.0, 58.0, 22.0 ],
                    "text": "r mute.all"
                }
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 738.5, 315.0, 56.0, 22.0 ],
                    "text": "thispoly~"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 737.0, 254.0, 59.0, 22.0 ],
                    "text": "mute 0, 1"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 192.0, 13.0, 28.0, 22.0 ],
                    "saved_object_attributes": {
                        "attr_comment": "",
                        "c": ""
                    },
            ...
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 378.0, 409.0, 139.5, 22.0 ],
                    "text": "line~"
                }
            },
            {
            ...
            {
                "box": {
                    "addpoints": [ 0.0, 0.0, 0, 28.33530343336953, 0.5039395591469963, 0, 48.642513114754465, 0.26204824567970936, 0, 120.42563926468337, 0.25532905989305055, 0, 177.56878573929797, 0.0, 0 ],
                    "classic_curve": 1,
