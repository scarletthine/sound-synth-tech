        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "bang" ],
                    "patching_rect": [ 409.0, 475.0, 41.0, 22.0 ],
                    "text": "line 0."
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 409.0, 437.0, 71.0, 22.0 ],
                    "text": "pack f 2000"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 139.0, 525.0, 253.0, 22.0 ],
                    "text": "pack f f f"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 172.0, 306.0, 101.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 172.0, 256.0, 73.0, 22.0 ],
                    "text": "random 400"
                }
            },
            {
